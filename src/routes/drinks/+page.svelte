...
<div class="min-h-screen bg-[#fcdab7]"> 
  <div class="sticky top-0 z-30 bg-[#fcdab7] border-b border-orange-200/50 px-4 pt-4 pb-3 space-y-3 shadow-sm">
    <div class="max-w-4xl mx-auto flex flex-col gap-2">
      <a href="/" class="text-vibe-brown/70 hover:text-vibe-brown text-sm font-medium transition-colors">← Back to Home</a>

      <h1 class="text-2xl font-bold text-vibe-brown">Global Drinks Database</h1>
      ...
      <button
        class="w-fit px-6 py-2 rounded-xl bg-white/90 text-vibe-brown border border-orange-200 text-sm font-bold shadow-sm hover:scale-[1.02] transition-transform active:scale-95"
